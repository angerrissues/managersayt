...
const advantages = [
  {
    title: "Сильный ростер",
    description: "Мы тщательно отбираем креаторов для сотрудничества. Наша команда — это таланты, которые разделяют наш профессиональный подход к делу."
  },
  {
