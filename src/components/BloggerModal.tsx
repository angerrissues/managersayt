  ...
  return (
    ...
    >
      ...
      >
        ...
        <button 
          onClick={onClose}
          className="absolute top-3 right-3 md:top-5 md:right-5 p-3 md:p-2 rounded-full bg-white/10 hover:bg-white/20 transition-colors text-white z-20 cursor-none magnetic"
        >
          <X size={24} />
        </button>
          ...
          <div className="md:w-2/3 flex flex-col gap-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              {blogger.socials.tiktok && (
                <a href={blogger.socials.tiktok.url} target="_blank" rel="noreferrer" className="block p-3 md:p-4 bg-gradient-to-br from-[#25F4EE]/10 to-[#FE2C55]/10 border border-white/10 rounded-2xl hover:border-white/30 transition-colors cursor-none magnetic group">
              ...
              {blogger.socials.youtube && (
                <a href={blogger.socials.youtube.url} target="_blank" rel="noreferrer" className="block p-3 md:p-4 bg-gradient-to-br from-red-500/10 to-red-900/10 border border-white/10 rounded-2xl hover:border-white/30 transition-colors cursor-none magnetic group">
                  <div className="flex items-center gap-3 mb-3 text-white">
              ...
              {blogger.socials.instagram && (
                <a href={blogger.socials.instagram.url} target="_blank" rel="noreferrer" className="block p-3 md:p-4 bg-gradient-to-br from-pink-500/10 to-purple-500/10 border border-white/10 rounded-2xl hover:border-white/30 transition-colors cursor-none magnetic group">
                  <div className="flex items-center gap-3 mb-3 text-white">
              ...
              {blogger.socials.telegram && (
                <a href={blogger.socials.telegram.url} target="_blank" rel="noreferrer" className="block p-3 md:p-4 bg-gradient-to-br from-blue-400/10 to-blue-600/10 border border-white/10 rounded-2xl hover:border-white/30 transition-colors cursor-none magnetic group">
                  <div className="flex items-center gap-3 mb-3 text-white">
              ...
              {/* VK */}
              {blogger.socials.vk && (
                <a href={blogger.socials.vk.url} target="_blank" rel="noreferrer" className="block p-3 md:p-4 bg-gradient-to-br from-[#0077FF]/10 to-[#0077FF]/5 border border-white/10 rounded-2xl hover:border-white/30 transition-colors cursor-none magnetic group">
                  <div className="flex items-center gap-3 mb-3 text-white">
