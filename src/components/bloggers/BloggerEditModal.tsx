  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-[#111] border border-white/10 rounded-3xl p-4 md:p-6 max-w-[1000px] w-full relative my-auto cursor-auto shadow-2xl h-fit max-h-[95vh] overflow-y-auto"
