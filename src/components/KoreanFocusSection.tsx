...
export default function KoreanFocusSection() {
  ...
  return (
    ...
    >
      {/* Massive Background Text with Parallax — hidden on mobile for performance */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full flex-col items-center justify-center pointer-events-none select-none z-0 opacity-20 hidden md:flex">
        <motion.h2 
          style={{ x: xLeft, y, rotate: rotateLeft }}
          className="text-[20vw] font-black uppercase tracking-tighter leading-none text-transparent bg-clip-text bg-gradient-to-r from-red-500 via-purple-500 to-blue-500 blur-md"
        >
          SEOUL
        </motion.h2>
        <motion.h2 
          style={{ x: xRight, y, rotate: rotateRight }}
          className="text-[20vw] font-black uppercase tracking-tighter leading-none text-transparent bg-clip-text bg-gradient-to-l from-red-500 via-purple-500 to-blue-500 blur-md"
        >
          VIBES
        </motion.h2>
      </div>
