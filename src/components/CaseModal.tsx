          ...
          <div className="space-y-6">
            ...
            <div className="p-4 md:p-6 bg-white/5 border border-white/10 rounded-2xl">
              ...
              <div className="flex flex-wrap gap-2">
                {caseData.bloggers.map((blogger, i) => (
                  <span key={i} className="px-3 py-1.5 md:px-4 md:py-2 bg-white/10 border border-white/5 rounded-full text-xs md:text-sm text-white/90 hover:bg-white/20 hover:text-white transition-colors cursor-none">
                    {blogger}
                  </span>
                ))}
              </div>
